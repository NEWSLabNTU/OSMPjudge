...
2. MP0 requires the submitted zip file to have the following structure:
...
3. If any error occurs during grading, the judge continue to the next students and warn you in the terminal. You may have to grade them manually.
